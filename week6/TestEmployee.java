...
public class TestEmployee {
    public static void main(String[] args) {
        ...
        Employee e3 = new Employee("Joe Balls",134,new Address("Paul","Paul","Paul","Paul","V93 NY30"),new Insurance("Bals Insurance",454364));
        Employee e4 = new Employee("Joe Mama",3251,new Address("Eggs","Eggs","Eggs","Eggs","V93 NY30"),new Insurance("Mama Insurance",7777345));
        ...
        System.out.println("Now searching Employee objects for people called Joe.\n\nDetails of Joes are:\n\n");

        String listOfJoes="";
        int subJoe=-1;

        for(int i=0; i<allEmployees.length; i++){
            if(allEmployees[i]!=null && allEmployees[i].getName().toLowerCase().contains("joe"))
                listOfJoes+=allEmployees[i].toString()+"\n\n";
                subJoe=i;
        }
